...
if (sendBtn && messageText) {
    sendBtn.addEventListener('click', function() {
        ...
        if (text !== '') {
            // Reemplaza 1234567890 con tu número de teléfono (en formato internacional)
            // Ejemplo: +51987654321 para Perú, +573001234567 para Colombia, etc.
            const phoneNumber = "+573209531711";
